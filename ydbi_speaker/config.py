...
SPEAKER_MAX_IN_FLIGHT_SEGMENTS = int(os.getenv("SPEAKER_MAX_IN_FLIGHT_SEGMENTS", "3"))
SPEAKER_TTS_CONCURRENCY = 1
SEGMENT_RUNNING_TIMEOUT_SECONDS = 100
...
VOXCPM_DEVICE = (os.getenv("VOXCPM_DEVICE") or "auto").strip() or "auto"
...
DUBBING_MULTI_SEGMENT_PROFILE_ENABLED = True
