...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate a test speaker WAV from a reference WAV and text.")
    ...
    output = synthesize_from_reference(args.reference_audio_path, args.text, args.output_path)
    print(output)
